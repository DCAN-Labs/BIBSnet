...
RUN apt-get update -qq \
    ...
    && curl -sSL "https://s3.msi.umn.edu/bibsnet-data/bibsnet-v3.3.0-rmCC.tar.gz" \
...
RUN curl -sSL "https://s3.msi.umn.edu/bibsnet-data/bibsnet-v3.3.0-rmCC.tar.gz" | tar -xzpf - Task540_BIBSNet_Production_Model.tar.gz -O | tar -xzpC /opt/nnUNet/nnUNet_raw_data_base/nnUNet_trained_models/nnUNet --no-same-owner --strip-components 1
...
RUN curl -sSL "https://s3.msi.umn.edu/bibsnet-data/bibsnet-v3.3.0-rmCC.tar.gz" | tar -xzpf - data.tar.gz -O | tar -xzpC /home/bibsnet/data --no-same-owner --strip-components 1
